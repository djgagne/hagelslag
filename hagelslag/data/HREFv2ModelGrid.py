...
class ModelGrid(object):
	...
	def __init__(self, filenames, 
		...
		self.__enter__()
		self.data = None		
		self.unknown_names = {3:"LCDC", 4:"MCDC", 5:"HCDC", 197:"RETOP", 198:"MAXREF", 199:"MXUPHL", 200:"MNUPHL", 220:"MAXUVV", 221:"MAXDVV", 222:"MAXUW", 223:"MAXVW"}
       		self.unknown_units = {3:"%", 4:"%", 5:"%", 197:"m", 198:"dB", 199:"m**2 s**-2", 200:"m**2 s**-2", 220:"m s**-1", 221:"m s**-1", 222:"m s**-1", 223:"m s**-1"}
				...
				if type(var) is int:
					...
					if '_' in var:  
						...
						if var in unknown_names.values():
							...
							raise NameError ("Multiple {0} records found. Rename with associated level, in format:'{0}_level'".format(var))
						else:
