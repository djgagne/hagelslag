...
if __name__ == "__main__":
    ...
    config = dict(dates=None,
                  ...
                  potential_variables=['Precipitable water_0', 'Temperature_1000', 'Dew point temperature_1000',
                                       'Geopotential Height_500', 'Temperature_500',
                                       'Dew point temperature_500', 'U component of wind_500', 'V component of wind_500',
                                       'Geopotential Height_700', 'Temperature_700', 'Dew point temperature_700',
                                       'U component of wind_700',
                                       'V component of wind_700', 'Geopotential Height_850', 'Temperature_850',
                                       'Dew point temperature_850',
                                       'U component of wind_850', 'V component of wind_850', 'MAXUW', 'MAXVW',
                                       'Surface lifted index', 'Convective available potential energy_0',
                                       'Convective inhibition_0'],
    ...
    date_index = pd.date_range(start="2018-05-01T00:00", end="2018-06-02T00:00", freq="1D")
    ...
    sector_csv_outpath = "/hail/aburke/testing_weights/sector_trained/{0}/track_data_spring2018_MAXUVV_closest_csv/".format(
        sector)
    sector_nc_outpath = "/hail/aburke/testing_weights/sector_trained/{0}/track_data_spring2018_MAXUVV_patch_nc/".format(
        sector)
    patch_radius = 16
